        ...
        <div class="content sec-title center wrapTextBreadcrumb">
            <div class="container containerTextBreadcrumb">
                ...
                <ol class="breadcrumb olListBreqadcrumb">
                    ...
                    <li class='itemListBreadcrumb active'><a href='tintuc.php' class='linkListBreadcrumb'>Tin Tức</a></li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="listFoodMenu">
                <div class="row rowListFoodMenu">
                    <?php foreach($datas as $data){?>
                        <div class="col-sm-6 col-md-4 colItemFoodMenu">
                            <div class="sec-title center contentItemFoodMenu">
                                <div class="wrapBorderImgItemFoodMenu">
                                    <div>
                                        <img src="images/<?php echo $data["HinhAnh"];?>" alt="" class="wrap-img wrapImgItemFoodMenu" style="width:348px; height: 224px;"/>
                                    </div>
                                </div>
                                <a href="chitietTT.php?id=<?php echo $data['id'];?>">
                                    <h3 class="h2 titlefood titleHeadingItemFoodMenu"><?php echo $data["TenTT"];?></h3>
                                </a>
                                <div class="priceItemFoodMenu"><?php echo $data["NoiDung"];?></div>
                            </div>
                        </div>
                    <?php }?>
                </div>
