...
<body>
    ...
    <div class="wrapBreadCrumb">
        ...
        <div class="content sec-title center wrapTextBreadcrumb">
            <div class="container containerTextBreadcrumb">
                <h1 class="h2 title titlePageCurrentBreadcrumb">THỰC ĐƠN</h1>
                <ol class="breadcrumb olListBreqadcrumb">
                    ...
                    <li class='itemListBreadcrumb active'><a href='thucdon.php' class='linkListBreadcrumb'>Thực Đơn</a></li>
                </ol>
            </div>
            </div>
        </div>
    ...
    <div class="titleControlFillterFood">Thực đơn</div>
                            ...
                            <div class="sec-title center contentItemFoodMenu">
                                <div class="wrapBorderImgItemFoodMenu">
                                    <div class="thu-nghiem-zoom">
                                        <img src="images/<?php echo $data["HinhAnh"];?>"  class="imgItemFoodMenu "/>
                                    </div>
                                </div>

                                <h3 class="h2 titlefood titleHeadingItemFoodMenu"><?php echo $data["TenMon"];?></h3>

                                <div class="priceItemFoodMenu"><?php echo $data["Gia"];?> VNĐ</div>
                            </div>
                        </div>
                    <?php }?>
                </div>
